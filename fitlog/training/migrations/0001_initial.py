    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('muscle', models.CharField(choices=[('chest', 'Chest'), ('back', 'Back'), ('shoulders', 'Shoulders'), ('biceps', 'Biceps'), ('triceps', 'Triceps'), ('lower_back', 'Lower back'), ('glutes', 'Glutes'), ('legs', 'Legs'), ('calf', 'Calf'), ('abs', 'Abs')], max_length=128)),
            ],
            options={
                'db_table': 'exercises',
            },
