# Generated by Django 2.1.7 on 2019-03-16 09:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exercise', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='training_sets', to='training.Exercise')),
                ('training', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='training_sets', to='training.Training')),
            ],
            options={
